...
#generate subplot description
par(mfrow=c(2,2))
#create first plot
plot(pwr_data_cut$dtime, pwr_data_cut[, "Global_active_power"], xlab="", ylab="", type="l")
title(ylab = "Global Active Power" )

#create second plot
plot(pwr_data_cut$dtime, pwr_data_cut$Voltage, type="l", col="black", ylab = "",xlab="")
...
#create fourth plot
plot(pwr_data_cut$dtime, pwr_data_cut$Global_reactive_power, type="l", col="black", ylab = "",xlab="")
title(ylab = "Gobal_reactive_power", xlab = "datetime" )
